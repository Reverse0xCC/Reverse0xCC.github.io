...
为了适配我平时的使用习惯，我首先进行一些个性化设置

将任务栏设置为底部显示
<img width="3200" height="1904" alt="image" src="https://github.com/user-attachments/assets/258c700c-be13-4ead-b012-4d4025680a1d" />

切换为深色主题
<img width="3200" height="1904" alt="image" src="https://github.com/user-attachments/assets/6dc7d245-56ac-4a61-86bf-9c72319c0cb9" />

设置个人常用的快捷键。我个人设置了`Win+E`打开Home目录，`Win+I`打开设置（对标Windows快捷键）
<img width="3200" height="1904" alt="image" src="https://github.com/user-attachments/assets/19a51a16-0213-4db7-aa37-dd359a7da6de" />
<img width="3200" height="1904" alt="image" src="https://github.com/user-attachments/assets/59f90992-0a6d-4e4d-b6c3-6e9fd7a723f5" />
<img width="3200" height="1904" alt="image" src="https://github.com/user-attachments/assets/3b0caf67-13aa-4221-a58c-6faadb5149d0" />

关闭自动锁屏。否则一段时间不使用，就要你输入密码解锁，很麻烦
<img width="3200" height="1904" alt="image" src="https://github.com/user-attachments/assets/713fdbb1-4a4f-497c-bece-61e9cd268b1b" />

## 安装`open-vm-tools`

VMware Workstation如今不再默认提供vmtools。为了方便在虚拟机与主机之间传递文件，先安装`open-vm-tools`工具包

按`Ctrl+Alt+T`打开终端，输入`sudo apt update`
